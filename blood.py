...
con = cx_Oracle.connect('sys', 'Giri0707', 'localhost:1522/ORCL2', mode=cx_Oracle.SYSDBA)
cursor = con.cursor()
cursor = con.cursor()
root = Tk()
root.configure(background='white')

#image1 = PhotoImage(file="C:\\Users\\girij\\pythonnew\\wooooo.jpg")
#panel = Label(root, image=image1, bg="black").place(x=0, y=0, relwidth=1, relheight=1)
root.title("BLOOD INVENTORY AND DONOR MANAGEMENT SYSTEM (BIDMS)")
root.geometry("1200x672")
root.configure(background='white')


l3 = Label(root, text="BLOOD INVENTORY AND DONOR MANAGEMENT SYSTEM", bg='pink', font="Helvetica 15 bold",fg='Black').place(x=300, y=50, w=700, h=60)
b1 = Button(root, text="Click to enter the details of the donor",command=lambda:donordetails(), bg='lightblue', font="Helvetica 12").place(x=80, y=200,w=300, h=40)
b2 = Button(root, text="Click to enter the details of the blood",command=lambda:blooddetails(),bg='lightblue', font="Helvetica 12").place(x=80, y=300,w=300, h=40)
b3 = Button(root, text="Click to make a request for blood",command=lambda:requestblood(), bg='lightblue', font="Helvetica 12").place(x=80, y=400, w=300,
                                                                                                  h=40)
b2 = Button(root, text="EXIT", bg='light green',font='Helvetica 18 bold',command=lambda: stop(root)).place(x=180, y=500,w=90)
v = StringVar()
...
def grid1(bg):
    ...
    root.configure(background='#edfeff')
    rows = retrieve(bg)
    Label(root, text='NAME', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=0, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='AGE', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=1, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='GENDER', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=2, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='ADDRESS', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=3, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='CONTACT NO', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=4, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='ID', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=5, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='BLOOD GROUP', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=6, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='PLATELET', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=7, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)
    Label(root, text='RBC', bg="#72effc", font="Verdana 15 bold").grid(row=0, column=8, sticky='E', padx=5,
                                                                        pady=5, ipadx=5, ipady=5)

    x = 1
    for row in rows:
        Label(root, text=row[0], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=0, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[1], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=1, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[2], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=2, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[3], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=3, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[4], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=4, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[5], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=5, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[6], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=6, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[7], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=7, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
        Label(root, text=row[8], bg="#FFFFFF", font="Verdana 15 bold").grid(row=x, column=8, sticky='E', padx=5,
                                                                                 pady=5, ipadx=5, ipady=5)
